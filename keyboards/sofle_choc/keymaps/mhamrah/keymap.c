...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT, KC_B,   KC_Z,   KC_X,   KC_C,   KC_V, KC_MUTE,                        RGB_TOG, KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    ...
    [_MAC_UTIL] = LAYOUT(
        ...
        KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_NEXT, RGB_TOG,            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
